...
The {{edition.description}} ({{site.title}} {{ year }}) will take place on {{ edition.dates }}. The workshop will be co-located with the [ 32<sup>th</sup>  International European Conference on Parallel and Distributed Computing (Euro-Par 2026)](https://2026.euro-par.org/){:target="_blank"}.
